In this project, let's build a **Hamburger Menu** by applying the concepts we have learned till now.
...
- [Extra Small (Size < 576px) and Small (Size >= 576px) - Home](https://assets.ccbp.in/frontend/content/react-js/hamburger-menu-home-sm-output.png)
- [Extra Small (Size < 576px) and Small (Size >= 576px) - About](https://assets.ccbp.in/frontend/content/react-js/hamburger-menu-about-sm-output.png)
- [Extra Small (Size < 576px) and Small (Size >= 576px) - Menu](https://assets.ccbp.in/frontend/content/react-js/hamburger-menu-popup-sm-output.png)
- [Extra Small (Size < 576px) and Small (Size >= 576px) - Not Found](https://assets.ccbp.in/frontend/content/react-js/hamburger-menu-not-found-sm-output.png)
...
- When hamburger icon button is clicked the Header, then the popup should be opened
  <div style="text-align: center;">
...
- `About` route should consist of "/about" in URL path
